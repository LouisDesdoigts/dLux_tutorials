...
- `getting_started.ipynb`: build, simulate, and fit a complete differentiable imaging
  model.
- `prebuilt.ipynb`: use, customise, and understand named telescope-like components.
- `propagators_optics.ipynb`: construct basic optics and choose between Fraunhofer,
  Fresnel, free-space, FFT, MFT, and ABCD propagation from their physical and sampling
  requirements.
